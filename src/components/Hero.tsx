...
function NowStatusLine() {
  ...
  return (
    <p
      aria-live="polite"
      className="mx-auto mt-8 flex min-h-9 w-[calc(100vw-24px)] flex-col items-center justify-center gap-1 text-center text-[16px] leading-[1.2] tracking-[-0.01em] text-primary sm:mt-10 sm:w-full sm:min-h-9 sm:flex-row sm:gap-1.5 lg:w-auto lg:min-h-10 lg:gap-2 lg:text-[20px] dark:text-[#E6E6E6]"
