  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="relative inline-flex min-h-9 max-w-full overflow-hidden rounded-[8px] bg-primary px-2.5 py-1 text-white will-change-[width] sm:px-3 sm:py-1.5 lg:min-h-10 lg:px-3.5 lg:py-2 dark:bg-[#E6E6E6] dark:text-[#1E1E1E]"
      >
