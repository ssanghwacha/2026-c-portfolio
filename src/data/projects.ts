...
export const projects: Project[] = [
  { slug: 'grocery-nav',  title: 'Grocery Nav',  year: 2026, category: 'product',   thumbnailVideo: '/assets/projects/grocery-nav/thumbnail.mp4', description: 'A mobile navigation system that helps shoppers find products faster in large grocery stores.' },
