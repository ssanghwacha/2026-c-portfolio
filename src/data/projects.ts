...
export const projects: Project[] = [
  ...
  { slug: 'altra',       title: 'Altra',       year: 2025, category: 'product',   thumbnail: '/assets/projects/altra/thumbnail.jpg',       description: 'A mobile system that helps hikers understand risk and make clearer decisions on the trail.' },
  { slug: 'bgzt',        title: 'BGZT',        year: 2025, category: 'branding',  thumbnail: '/assets/projects/bgzt/thumbnail.jpg',        description: `A brand identity designed around BGZT's delivery experience.` },
